...
kAddrMin = 0x1000
kAddrMax = 0x1FFF
kFunction = ["ADD", "SUB", "SetLessThan", "Mult", "Load", "Store", "BranchOnEqual", "Determinant"]  # ****
# kFunction = ["ADD", "SUB", "SetLessThan", "Mult", "Load", "Store", "BranchOnEqual"]
kOffset = 0x1000

core_reg = [0 for i in range(16)]
DRAM_data = {}
DRAM_inst = {}
operation_cnt = {"ADD": 0, "SUB": 0, "SetLessThan": 0, "Mult": 0, "Load": 0, "Store": 0, "BranchOnEqual": 0, "Determinant": 0}
...
def simulate(pc):
    ...
    while True:
        ...
        coeff_a = int(inst[3:7], 2)
        coeff_b = int(inst[7:15], 2)
        func = inst[15]
        imm = inst[11:16]
        ...
        if opcode == "000" and func == "0":  # ADD
            ...
            print(f"ddddddddddddddddddddddddddddd    {temp:0>4x}")
        ...
        elif opcode == "111":  # Determinant
            print("Determinant")
            det_num = core_reg[0] * (
                core_reg[5] * core_reg[10] * core_reg[15]
                + core_reg[6] * core_reg[11] * core_reg[13]
                + core_reg[7] * core_reg[9] * core_reg[14]
                - core_reg[7] * core_reg[10] * core_reg[13]
                - core_reg[6] * core_reg[9] * core_reg[15]
                - core_reg[5] * core_reg[11] * core_reg[14]
            )
            -core_reg[4] * (
                core_reg[1] * core_reg[10] * core_reg[15]
                + core_reg[2] * core_reg[11] * core_reg[13]
                + core_reg[3] * core_reg[9] * core_reg[14]
                - core_reg[3] * core_reg[10] * core_reg[13]
                - core_reg[2] * core_reg[9] * core_reg[15]
                - core_reg[1] * core_reg[11] * core_reg[14]
            )
            +core_reg[8] * (
                core_reg[1] * core_reg[6] * core_reg[15]
                + core_reg[2] * core_reg[7] * core_reg[13]
                + core_reg[3] * core_reg[5] * core_reg[14]
                - core_reg[3] * core_reg[6] * core_reg[13]
                - core_reg[2] * core_reg[5] * core_reg[15]
                - core_reg[1] * core_reg[7] * core_reg[14]
            )
            -core_reg[12] * (
                core_reg[1] * core_reg[6] * core_reg[11]
                + core_reg[2] * core_reg[7] * core_reg[9]
                + core_reg[3] * core_reg[5] * core_reg[10]
                - core_reg[3] * core_reg[6] * core_reg[9]
                - core_reg[2] * core_reg[5] * core_reg[11]
                - core_reg[1] * core_reg[7] * core_reg[10]
            )

            temp = det_num >> (2 * coeff_a)
            temp += coeff_b
            ...
            operation_cnt["Determinant"] += 1
            core_reg[0] = core0_tmp
            is_legal = True
...
def print_summary():
    ...
    print("Determinant = " + str(operation_cnt["Determinant"]))
